package com.microservices.mini.project.currencyexchangeservice.exception;
...
public class StandardExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Object> handleCurrencyNotFoundException(CurrencyNotFoundException ex,
                                                           WebRequest request) {
        StandardExceptionResponse standardExceptionResponse =
                new StandardExceptionResponse(new Date(), ex.getMessage(),
                        request.getDescription(false));
